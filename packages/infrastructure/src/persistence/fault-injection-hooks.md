...
| Snapshot retain  | `snapshot.retain.after-completion-before-receipt`  | The new snapshot is durable but receipt fails.                                               |
...
| Snapshot restore | `snapshot.restore.after-completion-before-receipt` | Restored state is durable but receipt fails.                                                 |
