...
| --------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| Full repository verification      | `NOTEQUEST_RELEASE_ID=e623853c5157f288448d71643f8a009a347e30eb npm run verify`                                                                                                                                                                                   | Passed at the verified source state: 41 test files and 438 tests, release-ID checks, build, PWA/fault-boundary checks, and audit. |
