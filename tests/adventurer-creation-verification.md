...
| --------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| Full repository verification      | `NOTEQUEST_RELEASE_ID=71452d3000000000000000000000000000000000 npm run verify`                                                                                                                                                                                   | Passed at the verified source state: 41 test files and 437 tests, release-ID checks, build, PWA/fault-boundary checks, and audit. |
